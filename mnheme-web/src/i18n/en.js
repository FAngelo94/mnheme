...
const en = {
  ...
  perceive: {
    ...
    micListening: 'Listening... speak freely',
    chars: 'chars',
  ...
  settings: {
    ...
    // ── Multi-provider ──
    providerListTitle: 'LLM PROVIDERS',
    providerListDesc: 'Configure one or more providers in priority order. If the first fails, the system automatically tries the next one.',
    addProvider: 'Add Provider',
    removeProvider: 'Remove',
    moveUp: 'Move up',
    moveDown: 'Move down',
    providerName: 'NAME',
    providerUntitled: 'Untitled provider',
    noProviders: 'No providers configured. Add a provider to use cognitive functions.',
    // ── Export / Import providers ──
    exportImportTitle: 'EXPORT / IMPORT PROVIDERS',
    exportApiKeyWarning: 'The exported file includes API keys in plain text. Store it securely and do not share it publicly.',
    exportProvidersBtn: 'Export Providers',
    exportProvidersEmpty: 'No providers to export.',
    exportProvidersSuccess: 'Exported {count} provider(s).',
    importProvidersFileLabel: 'IMPORT FROM JSON FILE',
    importProvidersSuccess: 'Imported {count} provider(s). They replace the previous configuration.',
    importProvidersError: 'Import error: {error}',
    importProvidersInvalidFormat: 'The file must contain a JSON array.',
    importProvidersInvalidProvider: 'Each provider must have at least "url" and "model" fields.',
    exportImportCompleted: 'Completed',
    exportImportErrorLabel: 'Error',
  },
