...
const it = {
  ...
  settings: {
    ...
    // ── Multi-provider ──
    providerListTitle: 'PROVIDER LLM',
    providerListDesc: 'Configura uno o più provider in ordine di priorità. Se il primo fallisce, il sistema prova automaticamente il successivo.',
    addProvider: 'Aggiungi Provider',
    removeProvider: 'Rimuovi',
    moveUp: 'Sposta su',
    moveDown: 'Sposta giù',
    providerName: 'NOME',
    providerUntitled: 'Provider senza nome',
    noProviders: 'Nessun provider configurato. Aggiungi un provider per usare le funzioni cognitive.',
    // ── Export / Import providers ──
    exportImportTitle: 'ESPORTA / IMPORTA PROVIDER',
    exportApiKeyWarning: 'Il file esportato include le chiavi API in chiaro. Conservalo in modo sicuro e non condividerlo pubblicamente.',
    exportProvidersBtn: 'Esporta Provider',
    exportProvidersEmpty: 'Nessun provider da esportare.',
    exportProvidersSuccess: '{count} provider esportati.',
    importProvidersFileLabel: 'IMPORTA DA FILE JSON',
    importProvidersSuccess: '{count} provider importati. Sostituiscono la configurazione precedente.',
    importProvidersError: 'Errore importazione: {error}',
    importProvidersInvalidFormat: 'Il file deve contenere un array JSON.',
    importProvidersInvalidProvider: 'Ogni provider deve avere almeno i campi "url" e "model".',
    exportImportCompleted: 'Completato',
    exportImportErrorLabel: 'Errore',
  },
